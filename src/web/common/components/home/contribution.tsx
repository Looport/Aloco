...
import {Card, CardTitle, CardTooltip} from "@/web/common/components/home/card"
import {
  FiThumbsUp,
  IconProvider,
  LiaAwardSolid,
    ...
    <div className={cn(["mb-10"])}>
      ...
      <div className={cn(["mb-2"])}>
        ...
        <div className={cn(["flex sm:flex-row flex-col justify-between"])}>
          ...
          <GoalItem
            title="$100k+"
            description={<span className={cn(["block text-right"])}>Goal</span>}
          />
        </div>
      </div>
    </div>
